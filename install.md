# Missing values guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `missing_values/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `missing_values` folder and use the modules inside your notebooks :
...
```python
from missing_values.utils.paths import data_dir
data_dir()
```
